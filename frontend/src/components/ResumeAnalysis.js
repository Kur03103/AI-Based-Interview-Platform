    ...
    >
      ...
      <motion.div variants={itemVariants}>
        <div className="flex items-center gap-3 mb-4">
          <motion.div
            className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-blue-500 to-cyan-600 flex items-center justify-center shadow-lg shadow-blue-500/30"
        ...
        <p className="text-lg text-gray-500">
          Get AI-powered insights with scores, strengths, weaknesses, and
              ...
              >
                <div className="text-center">
                  {fileName ? (
                    ...
                    <>
                      <div className="w-16 h-16 bg-gradient-to-tr from-blue-500 to-cyan-600 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                          viewBox="0 0 24 24"
